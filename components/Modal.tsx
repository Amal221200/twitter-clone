...
const Modal: React.FC<ModalProps> = ({ actionLabel, onClose, onSubmit, isOpen, title, body, footer, disabled }) => {
    ...
    return (
        <>
            <div className="flex justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800 bg-opacity-80">
                <div className="relative w-full lg:w-3/6 my-5 mx-auto lg:max-w-3xl h-full lg:h-auto">
                    {/* Content */}
