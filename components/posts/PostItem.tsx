        ...
        <div onClick={goToPost} className="border-b-[1px] border-neutral-800 p-5 cursor-pointer hover:bg-neutral-900 transition">
            <div className="flex flex-row items-start gap-3">
                ...
                <div>
                    ...
                    <div onClick={(e) => e.stopPropagation()} className="flex flex-row items-center mt-3 gap-4">
                        <div className="flex flex-row items-center gap-2 text-neutral-500 cursor-pointer transiton hover:text-sky-500">
                            <AiOutlineMessage size={20} />

                            <p>{data.comments?.length || 0}</p>
                        </div>
                        <div onClick={onLike} className="flex flex-row items-center gap-2 text-neutral-500 cursor-pointer transiton hover:text-red-500">
                            <LikedIcon size={20} color={isLiked? 'red' : ''} />
